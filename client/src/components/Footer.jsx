...
const Footer = () => {
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-emerald-50">
      
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-emerald-200 text-gray-600">
      ...
      <p className="py-4 text-center text-sm md:text-base text-gray-500">
        © {new Date().getFullYear()} Gitau.dev. All Rights Reserved.
      </p>
